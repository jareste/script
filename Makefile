...
RM = rm -rf
CC = cc
CFLAGS = -Werror -Wextra -Wall -O3 -Iinc -Iinc/libft -Iinc/printf  -DDEBUG -g #-DNOECHO
# CFLAGS = -Werror -Wextra -Wall -g -fsanitize=address -O3 -Iinc -Iinc/libft -Iinc/printf -DDEBUG
# CFLAGS = -Werror -Wextra -Wall -g -fsanitize=thread -O3 -Iinc -Iinc/libft -Iinc/printf #-DDEBUG
